        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" name="MERCHANT_ACC_NUMBER" id="MERCHANT_ACC_NUMBER" required
                        readonly>
                </div>
                <div class="form-group col-12">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-12">
                    <label>Status Transaksi</label>
                    <input type="text" class="form-control" name="STATUS_TRANSACTION_RF" id="STATUS_TRANSACTION_RF"
                        required readonly>
                </div>
                <div class="form-group col-12">
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" name="ISSUING_CUSTOMER_NAME" id="ISSUING_CUSTOMER_NAME"
                        required readonly>
                </div>
                <div class="form-group col-12">
                    <label>Costumer PAN</label>
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" name="TRANSACTION_TYPE_RF" id="TRANSACTION_TYPE_RF" required
                        readonly>
                </div>
            </div>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-12">
                    <label>Status Transaksi</label>
                    <input type="text" class="form-control" name="STATUS_TRANSACTION_TRX" id="STATUS_TRANSACTION_TRX"
                        required readonly>
                </div>
                <div class="form-group col-12">
                    <label>Accquiring Institution Name</label>
                ...
                <div class="form-group col-12">
                    <label>Costumer PAN</label>
                    <input type="text" class="form-control" name="CUSTOMER_PAN_TRX" id="CUSTOMER_PAN_TRX" required
                        readonly>
                </div>
                <div class="form-group col-12">
                    <label>RRN</label>
