...
Route::group(['middleware' => ['auth']], function () {
    ...
    //Change Password
    Route::get('/user/change-password', [\App\Http\Controllers\UserController::class, 'formChangePassword'])->name('users.password.change');
    Route::put('/user/change-password/{user_id}', [\App\Http\Controllers\UserController::class, 'changePassword'])->name('users.password.update');
});
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('password/{token}', [\App\Http\Controllers\Auth\ForgotPasswordController::class, 'showResetForm'])
        ->name('password.token');
